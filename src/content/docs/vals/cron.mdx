...
:::note[Crons in Remixed Vals]

When you Remix a Val with a cron, the cron may return to the 1 hr default interval for crons on Val Town. If that's not what you want, edit the interval in the cron file in your Remix.
